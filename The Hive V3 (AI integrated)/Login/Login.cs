    ...
    public partial class Login : Form
    {
        ...
        private void log_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (isVal)
                {
                    string query = "SELECT * FROM HiveUser.Customer WHERE Username = '" + textBox1.Text + "' AND Pass ='" + textBox2.Text + "'";
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            try
            {
                ...
                if (isVal)
                {
                    string query = "SELECT * FROM HiveAdmin.Adminstrator WHERE Username = '" + textBox1.Text + "' AND Pass ='" + textBox2.Text + "'";
                    SqlDataAdapter sda = new SqlDataAdapter(query, DBcon.con());
                    DataTable dt = new DataTable();
                    sda.Fill(dt);
